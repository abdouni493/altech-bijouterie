...
const ProductDetailModal: React.FC<ProductDetailModalProps> = ({
  ...
  // The badge above the price names the actual metal of the piece.
  const metalName = categoryLabel(offer?.metalTypeId);
  const metalLine = [metalName, offer?.calibre].filter(Boolean).join(' ')
    || (lang === 'fr' ? 'Pièce de joaillerie' : 'قطعة مجوهرات');
